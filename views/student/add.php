...
<form method="POST" action="/webdangkyhocphan/student/save" enctype="multipart/form-data" onsubmit="return validateForm();">
    ...
    <a href="/webdangkyhocphan/student/list" class="btn btn-secondary mt-2">Quay lại danh sách sản phẩm</a>
</form>
